...
export default function Services() {
      ...
      <section className=" py-16 max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-4 ">
        <div className="">
          <div className="flex items-center justify-between">
            ...
            <div>
              <Link href="/our-services" className="mt-4 px-5 py-2 text-sm font-medium text-gray-800 border border-gray-300 rounded-full hover:bg-gray-100 cursor-pointer">
                view all services
              </Link>
            </div>
          </div>
  ...
  {/* Website Development */}
  <div className="relative bg-white border border-[#404a5c51] p-6 rounded-lg overflow-hidden group">
    {/* Overlay */}
    ...
    <div className="relative z-10">
      ...
      <h3 className="text-lg font-semibold text-[#404A5C] mb-2 group-hover:text-white transition-colors duration-500">
        Website Development
      </h3>
      <p className="text-gray-600 text-sm group-hover:text-gray-200 transition-colors duration-500">
        Activecraft offers interactive, holistic, and complete web design
        and development services with core proficiency in E-Learning
        software, web application development, e-commerce website, CMS and
  ...
  <div className="relative bg-white border border-[#404a5c51] p-6 rounded-lg overflow-hidden group">
    ...
    <div className="relative z-10">
      ...
      <p className="text-gray-600 text-sm group-hover:text-gray-200 transition-colors duration-500">
        ...
        website by interactive features, custom-made for the online
