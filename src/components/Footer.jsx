      ...
      <footer className="bg-white pt-16 text-gray-700">
        <div className="max-w-screen-xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
          ...
          <div>
            ...
            <p className="">
              ActiveCraft specializes in Web Design and Development Services,
              Business IT Support &amp; Consulting, Mobile Applications
              Development Services, iPhone Application Development, Mobile Web
              Application Development, Database Application Development, Web
              Application.
          ...
          {/* Services */}
          <div>
            <h3 className="font-bold text-[#404A5C] mb-3 text-2xl">
              Quick Links
            </h3>
            <ul className="space-y-2">
              <li>
                <Link
                  href="/about-us"
                  className="hover:underline text-[15px] font-semibold"
                >
                  About Us
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2">
                ...
                <a
                  href="mailto:info@activecraft.com"
                  className="hover:underline text-[15px] font-semibold"
                >
            ...
            <div className="flex gap-3 mt-4  text-xl">
              <a
                href="https://www.facebook.com/Activecraft"
                target="_blank"
              ...
              <a
                href="https://x.com/activecraft12"
                target="_blank"
                className="w-10 h-10 flex items-center justify-center bg-[#FF9900] text-white rounded-full text-xl hover:bg-[#FF9900] transition"
              >
                <svg
              ...
              <a
                href="https://www.linkedin.com/in/activecraft-software-development-8b55a528/"
                target="_blank"
                className="w-10 h-10 flex items-center justify-center bg-[#FF9900] text-white rounded-full text-xl hover:bg-[#FF9900] transition"
              >
                <svg
          ...
          <div>
            ...
            <ul className="space-y-2 text-[15px] font-semibold">
              <li>
                <span className="text-[#FF9900]">🇮🇳</span> India
              </li>
              <li>
                <span className="text-[#FF9900]">🇨🇦</span> Canada
              </li>
              <li>
                <span className="text-[#FF9900]">🇺🇸</span> USA
              </li>
              <li>
                <span className="text-[#FF9900]">🇦🇺</span> Australia
              </li>
              <li>
                <span className="text-[#FF9900]">🇬🇧</span> UK
              </li>
              <li>
                <span className="text-[#FF9900]">🇳🇿</span> New Zealand
              </li>
              <li>
                <span className="text-[#FF9900]">🇸🇬</span> Singapore
              </li>
              <li>
                <span className="text-[#FF9900]">🇧🇳</span> Brunei Darussalam
              </li>
            </ul>
          </div>
        </div>
